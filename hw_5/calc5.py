...
while True:
    print('please, write 2 complex numbers')
    a1 = int(input('first number, a='))
    b1 = int(input('first number, b='))
    a2 = int(input('second number, a='))
    b2 = int(input('second number, b='))
    ...
    try:
        ...
        print('value error. please, write 2 complex numbers')
        ...
        if op=='+':
            ...
            try:
                c = q/w
            except Exception_Complex_to_exp:
                print('division by zero. please select another operation')
            else:
                print(c)
                break
        elif op=='==':
